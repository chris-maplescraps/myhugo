+++
title = 'Jupyter'
date = 2025-10-27T16:23:15+08:00
draft = false
slug = "8e03624"
description = ""
summary = ""
...
> - 下载完毕，点击 **anaconda installer** 开始安装
> 等待安装完成  
> 
> ### 开始执行 jupyter notebook
> - 双击 **ananconda** 程序
> - 选择 **jupyter notebook**
> 
...
> {{< figure src="/images/image-20250620164419520.png" alt=“xxx”  class=“” >}}
> 
> 2. 单击右下角环境变量，双击上半部分 **用户变量中的Path** ，若先前安装时勾选了添加环境变量，在此可查看到已添加的路径。  
> {{< figure src="/images/image-20250620164544069.png" alt=“xxx”  class=“” >}}
> 
...
> | 快捷键 | 功能 |
> |---| ---|
> |**a** | 在当前单 cell 上方创建新的 cell |
> |**b** | 在当前单 cell 下方创建新的 cell|    
> | **dd** | 删除当前的 cell |
> |**m** | 切换到 markdown 格式 |
> |**y** | 切换到 code 模式 |
> |**Ctrl + Enter** | 运行当前 cell（ 单元格  ） |
